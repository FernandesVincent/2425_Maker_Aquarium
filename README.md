...
Comme précédemment vous pouvez voir ci-dessous les prototypes de ce bloc de filtration suivi de la version finale,   
...
Le meuble et le PCB sont fait pour accueillir 4 ventilateur 12V de 120mmx120mm. Deux (paire entrée/sortie) à l'étage des bacs et deux ( paire entrée/sortie) à l'étage supérieur.   
...
Ces capteurs servent, comme leur nom l'indique, à vérifier le niveau de l'eau. Je me suis procuré ceux de Adafruit car leur prix est peu élevé et qu'ils suffisent pour l'utilité que j'en ai.  
...
Tout au long de cette présentation vous avez pu voir différentes parties du projet mais il est temps de montrer le résultat que j'ai réussi à obtenir à la fin de ce projet:   
